...
public class CameraSource {
    private static final String LOG_TAG = CameraSource.class.getSimpleName();
        ...
        synchronized (mCameraLock) {
            ...
            if (mProcessingThread != null) {
                try {
                    ...
                    Log.d(LOG_TAG, "Frame processing thread interrupted on release.");
                }
            ...
            if (mCamera != null) {
                ...
                try {
                    ...
                    Log.e(LOG_TAG, "Failed to clear camera preview: " + e);
                }
                mCamera.release();
                mCamera = null;
            }
    ...
    private Camera createCamera() {
        ...
        if (mFocusMode != null) {
            if (parameters.getSupportedFocusModes().contains(
                ...
                Log.i(LOG_TAG, "Camera focus mode: " + mFocusMode + " is not supported on this device.");
            }
        }
        ...
        if (mFlashMode != null) {
            if (parameters.getSupportedFlashModes().contains(
                ...
                Log.i(LOG_TAG, "Camera flash mode: " + mFlashMode + " is not supported on this device.");
            }
        }
    ...
    private void setRotation(Camera camera, Camera.Parameters parameters, int cameraId) {
        ...
        switch (rotation) {
            ...
            case Surface.ROTATION_270:
                ...
                break;
            default:
                Log.e(LOG_TAG, "Bad rotation value: " + rotation);
        }
        ...
        public void run() {
            ...
            while (true) {
                synchronized (mLock) {
                    while (mActive && (mPendingFrameData == null)) {
                        try {
                            ...
                            Log.d(LOG_TAG, "Frame processing loop terminated.", e);
                            return;
                        }
                    }
                ...
                try {
                    ...
                    Log.e(LOG_TAG, "Exception thrown from receiver.", t);
                } finally {
